...
2. Aggregate small local packs (minus those named by `--keep-pack`,
   referenced by the multi-pack-index, or carrying a `.keep`, `.promisor`,
   `.mtimes`, or `.bitmap` sidecar) into new packs and unlink the source packs.
