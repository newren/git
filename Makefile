...
LIB_OBJS += builtin/replay.o   # Oh, what a nasty hack
LIB_OBJS += builtin/checkout.o   # Oh, what a nasty hack
...
#BUILTIN_OBJS += builtin/checkout.o   # Oh, what a nasty hack
...
#BUILTIN_OBJS += builtin/replay.o   # Oh, what a nasty hack
